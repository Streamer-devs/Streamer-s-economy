module.exports.execute = async (client, message, args) => {
    ...
    else return message.reply(`You have claimed **${addMoney.amount}** <:mony:950081940218843146> as your daily credit & now you have **${addMoney.after}** <:mony:950081940218843146>.`);
};
