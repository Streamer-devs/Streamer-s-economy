...
exports.execute = async (client, message, args) => {
  ...
  if (!isBalanceEnough) return message.reply("Your balance is insufficient. You need <:mony:950081940218843146> "+hasItem.cost+" to buy this item.");
  ...
  return message.channel.send(`You purchased **${item}** for **<:mony:950081940218843146> ${hasItem.cost}**.`);
};
